    ...
    public void runOpMode() throws InterruptedException {
        ...
        Actions.runBlocking(
                drive.actionBuilder(new Pose2d(0, 0, 0))
                        ...
                        .waitSeconds(0.5)
                        .stopAndAdd(new armAction(arm, armUp))//shot3
                        .waitSeconds(0.2)
                        ...
                        .waitSeconds(0.2)
                        .strafeToLinearHeading(new Vector2d(-70,-29), Math.toRadians(-39), (pose2dDual, posePath, v) -> 40)
                        ...
                        .strafeToLinearHeading(new Vector2d(-70, -29), Math.toRadians(0), (pose2dDual, posePath, v) -> 40)
                        .build());
